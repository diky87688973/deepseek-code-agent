...
INI_TO_AGENT_MAP: Dict[str, str] = {
    ...
    "model_vision.vision_models": "AGENT_VISION_MODELS",
    "model_vision.image_tokens_per_image": "AGENT_IMAGE_TOKENS_PER_IMAGE",
    "model_vision.embed_max_bytes": "AGENT_VISION_EMBED_MAX_BYTES",
    "model_vision.embed_max_side": "AGENT_VISION_EMBED_MAX_SIDE",
