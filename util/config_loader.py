...
INI_TO_AGENT_MAP: dict[str, str] = {
    ...
    "context.history_max_messages": "AGENT_CONTEXT_HISTORY_MAX_MESSAGES",
    "context.excerpt_start_index": "AGENT_CONTEXT_EXCERPT_START_INDEX",
    "context.recent_user_rounds": "AGENT_CONTEXT_RECENT_USER_ROUNDS",
...
CONFIG_ONLY_DEFAULTS: dict[str, Any] = {
    ...
    "AGENT_CONTEXT_HISTORY_MAX_MESSAGES": 1000,
    "AGENT_CONTEXT_EXCERPT_START_INDEX": 99,
    "AGENT_CONTEXT_RECENT_USER_ROUNDS": 100,
